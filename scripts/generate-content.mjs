  ...
  [
    {
      ...
      description: "The first scenes establish that John has received a divine revelation. Christ is shown in majesty among the candlesticks, and the ‘seven churches’ are invoked as the audience of the revelation. The point here is not yet catastrophe. The point is authority: this prophecy comes from Christ, and it is meant for the Church.",
    },
    {
      label: "Heavenly worship",
      title: "The revelation rises into heaven.",
      description: "The imagery then shifts from earth to the heavenly court. The elders cast down their crowns, which means heaven itself recognizes God’s rule. The mood becomes ceremonial and cosmic. You are no longer just in John’s private revelation; you are in the throne room where the fate of the world is about to be disclosed.",
    },
    {
      label: "The Lamb and the scroll",
      title: "Everything turns on the sealed book and the Lamb.",
      description: "The central drama becomes: who is worthy to open the mysterious sealed book? The answer is the Lamb. The Lamb takes the book, and heaven responds with adoration. This is the hinge of Movement I: history is about to move because the worthy one has taken the scroll.",
    },
    {
  ...
  [
    {
      ...
      description: "Movement II opens with the 144,000 sealed. So before the next catastrophes begin, there is first an image of distinction and protection: God knows who are His. In the historical cycle, this functions like a pause after the seals and before the trumpets.",
    },
    {
    ...
    },
    {
      ...
      description: "The first run of trumpets strikes the natural world: hail and fire, the burning mountain thrown into the sea, Wormwood falling from heaven into the waters, and then the darkening of the sun, moon, and stars. So this middle section of Movement II is really about the world becoming disordered at the cosmic level — land, sea, rivers, sky, light itself.",
    },
    {
      label: "The abyss and war unleashed",
      title: "Judgment becomes demonic and militarized.",
      description: "Then the imagery grows more frightening and surreal. The fifth trumpet brings the locusts from the pit; the sixth trumpet releases the four angels; and finally comes the apocalyptic cavalry, the riders on fire-breathing horses, killing on a massive scale. So Movement II does not end with a quiet symbol. It ends with an escalation: from environmental catastrophe to infernal torment to warlike devastation.",
    },
  ],
  [
    {
      ...
      description: "The opening sequence centers on the two witnesses. They are not passive victims at first; they are given power, they testify, and they stand as God’s prophetic voice in the world. So the opening note of Movement III is not chaos but witness—truth being spoken in the face of opposition.",
    },
    {
      label: "Martyrdom and vindication",
      title: "The witnesses are struck down, but God overturns their defeat.",
      description: "Then the witnesses are slain, their bodies lie exposed and unburied, and it looks for a moment as though evil has won. But this humiliation is reversed: they rise and ascend into heaven, and an earthquake follows. So the second sequence is really martyrdom followed by vindication. Revelation loves this pattern: what looks like defeat is not the end.",
    },
    {
      label: "Heavenly worship",
    ...
    },
    {
      ...
      description: "This is the emotional heart of Movement III. The woman and dragon scene introduces the deep mythic conflict: birth, threat, pursuit, escape. Then Saint Michael and his angels fight the dragon, the woman is given wings to flee, and when the dragon sends a flood after her, the earth swallows it up. So this whole sequence is about satanic assault met by divine rescue.",
    },
    {
      label: "The beasts arise",
      title: "The dragon, frustrated, turns to political and religious monsters.",
      description: "At the end of the movement, the dragon does not simply disappear. Instead, he redirects his rage. He goes to war against those who keep God’s commandments, and then he gives power to the beast from the sea. The final scenes show the adoration of the dragon and the adoration of the beast. So the ending of Movement III is chilling: evil moves from open attack into organized, enthroned, worship-demanding power.",
    },
  ],
  [
    {
    ...
    },
    {
      ...
      description: "The movement closes with the Seven vials, which functions like a threshold scene. After proclamation and harvest, heaven prepares the bowls of wrath that will be poured out in the next movement. So Movement IV ends not in resolution, but in poised inevitability—judgment is no longer merely announced; it is ready in the hand.",
    },
  ],
  [
    {
      ...
      description: "Movement V opens with the angels receiving the vials. This is a threshold moment: what Movement IV prepared, Movement V now begins to pour out. The sense is no longer that judgment is merely announced; it is now being administered in sequence.",
    },
    {
    ...
    },
    {
      ...
      description: "After the bowls, the focus narrows from global plagues to a single symbolic figure: the Whore of Babylon seated on the waters, then seated on the beast. This is important dramatically. Movement V says, in effect: behind the corruption of the world stands a seductive and imperial order—wealthy, intoxicating, splendid, and doomed. Babylon is not just ugliness; it is beautiful corruption.",
    },
    {
      label: "Babylon falls",
    ...
    },
    {
      ...
      description: "The movement then makes one of Revelation’s sharpest reversals: after the harlot comes the marriage of the Lamb, and then Saint John and angel. In other words, once false union and false splendor are destroyed, true union is revealed. The movement closes not only on destruction, but on interpretation and invitation: John is shown what all this judgment was clearing the ground for.",
    },
  ],
  [
    {
      ...
      description: "Movement VI opens with the most triumphant martial image in the cycle: Christ on the White Horse. This is no longer the earlier atmosphere of warning, seals, or symbolic struggle at a distance. Now Christ is revealed in open conquest, as the one who comes to defeat the beastly powers directly. In the traditional Apocalypse sequence, this is the arrival of final divine intervention into history.",
    },
    {
      label: "Evil overthrown",
      title: "The beastly order collapses under divine victory.",
      description: "Then the enemies are overthrown: the defeated are cast into the pool of fire, and the dragon is enchained. This sequence is about restraint and collapse. The forces that once strutted across the world—beast, false power, satanic rage—are no longer ascendant. They are judged, bound, and stripped of dominion.",
    },
    {
      label: "Final judgment",
      title: "There is one last resistance, and then final judgment.",
      description: "Revelation does not end with a simple military victory scene. After the dragon is bound, the movement still includes Judges and Satan attacks the Holy City, followed by Last Judgment. So the structure here is subtle: there is a pause, a final testing, and then the universal reckoning. This means Movement VI is not just ‘evil loses’; it is ‘all things are brought to account.’",
    },
    {
      label: "New Jerusalem",
      title: "After judgment, the new world appears.",
      description: "Then the emotional world of the movement changes completely. The terrifying images give way to New Jerusalem, the angel measuring the city, and the ordered beauty of the renewed creation. The measuring scene matters because it suggests not chaos but perfection, proportion, and divine intentionality. What was torn apart in earlier movements is now reconstituted as a holy city.",
    },
    {
      label: "Communion",
      title: "The ending is not merely a city, but communion.",
      description: "The final sequence is intimate and luminous: River of life, Saint John and the angel, and Saint John before God. That is a beautiful ending for the whole cycle. Revelation closes not only with architecture or victory, but with presence, vision, and relationship. The river signals renewal and abundance; John’s final encounters show that the end of apocalypse is not just destruction of evil, but beholding God.",
    },
  ],
];
